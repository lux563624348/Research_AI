...
from gget_server_ext import GgetMCPExtended, SearchResult, SequenceResult, StructureResult, LocalFileResult
...
class GgetMCP(GgetMCPExtended):
    ...
    def _register_gget_tools(self):
        ...
        if self.extended_mode:
            ...
            # Register only the simplified versions of selected tools
